...
void manual_control()
{
  if (digitalRead(SwitchPin1) == LOW && SwitchState_1 == LOW) {
    toggleState_1 = !toggleState_1; //HIGH; relay state should change.
    SwitchState_1 = HIGH;
  ...
  if (digitalRead(SwitchPin3) == LOW && SwitchState_4 == LOW) {
  ...
  if (digitalRead(SwitchPin3) == HIGH && SwitchState_4 == HIGH) {
    toggleState_4 = !toggleState_4;
    digitalWrite(RelayPin4, !toggleState_4);
    Blynk.virtualWrite(VPIN_BUTTON_4, toggleState_4);
    SwitchState_4 = LOW;
  ...
  if(count == 1000){
    int power = toggleState_1*power1 + toggleState_2*power1 + toggleState_3*power2 +toggleState_4*power3;
    Blynk.virtualWrite(VPIN_BUTTON_6, power);
    count = 0;
  }
  count = count + 1;
}
